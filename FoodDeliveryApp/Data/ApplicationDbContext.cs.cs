    ...
    public class ApplicationDbContext : DbContext
    {
        ...
        protected override void OnModelCreating(ModelBuilder modelBuilder)
        {
            ...
            modelBuilder.Entity<AdminModel>().HasData(
                new AdminModel { AdminId = 1, Name = "SuperAdmin", Email = "admin@example.com", Password = "admin@123", PhoneNumber = "1234567890", Role = "SuperAdmin" }
            );
            // Customers
            modelBuilder.Entity<CustomerModel>().HasData(
                new CustomerModel { CustomerId = 1, CustomerName = "John Doe", Email = "john@example.com", Password = "john@123", PhoneNumber = "9876543210", Address = "123 Main Street" },
                new CustomerModel { CustomerId = 2, CustomerName = "Jane Smith", Email = "jane@example.com", Password = "jane@123", PhoneNumber = "5554443322", Address = "456 South Avenue" }
            );
            // Items
            modelBuilder.Entity<ItemModel>().HasData(
                new ItemModel { ItemId = 1, ItemName = "Margherita Pizza", Description = "Classic cheese pizza", Price = 9.99m, IsAvailable = true },
                new ItemModel { ItemId = 2, ItemName = "Veggie Burger", Description = "Delicious burger with veggie patty", Price = 7.49m, IsAvailable = true },
                new ItemModel { ItemId = 3, ItemName = "Pepperoni Pizza", Description = "Pizza with pepperoni toppings", Price = 10.99m, IsAvailable = true },
                new ItemModel { ItemId = 4, ItemName = "Chicken Burger", Description = "Juicy chicken burger", Price = 8.49m, IsAvailable = true },
                new ItemModel { ItemId = 5, ItemName = "French Fries", Description = "Crispy golden fries", Price = 3.49m, IsAvailable = true }
            );
            // Orders
